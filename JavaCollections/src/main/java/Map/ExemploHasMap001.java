...
public class ExemploHasMap001 {
    public static void main(String[] args) {
        ...
        //Retorna se existe ou não alguma seleção hexa campeã - Boolean
        System.out.println(campeoesMundialFifa.containsKey(6));

        //Retorna o tamanho do mapa
        System.out.println("Quantidade de Elementos: "+campeoesMundialFifa.size());
